    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={dismissSupportPrompt}
          className="w-full rounded-2xl bg-blue-500 px-5 py-3.5 text-[15px] font-semibold text-white transition-all hover:bg-blue-600 active:scale-[0.98] dark:bg-blue-500 dark:hover:bg-blue-400"
        >
          继续使用
        </button>
      </div>
